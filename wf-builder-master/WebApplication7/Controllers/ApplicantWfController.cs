...
{
    [ApiController]
    [Route("api/applicant-wf")]
    public class ApplicantWfController : ControllerBase
    {
        private readonly MnccContext _context;
        public ApplicantWfController(MnccContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Init(int id, string name)
        {
            ...
            var wf = WorkflowInstance.Init("hassan", "fftsikj", id, WfType.Applicant);
